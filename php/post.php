...
use App\DBController, App\PostHandler;

// Create a DBController instance to handle database connections
$db = new DBController();
$dp = new PostHandler();
//$dp->displayPost($title);
...
<!--					 --><?php //= $title ?>
    ...
    <section class="bg0 p-b-70 p-t-5">
        <!-- Title -->
<!--        <div class="bg-img1 size-a-18 how-overlay1" style="background-image: url(../images/posts/--><?php //=$image;?>
<!--        <div class="bg-img1 size-a-18 how-overlay1" style="background-image: url('../images/--><?php //=$image;?>/*');">*/
